...
import org.saydroid.ngn.media.NgnMediaType;
import org.saydroid.ngn.media.NgnProxyAudioConsumer;
import org.saydroid.ngn.media.NgnProxyAudioProducer;
import org.saydroid.ngn.media.NgnProxyPlugin;
import org.saydroid.ngn.media.NgnProxyPluginMgr;
import org.saydroid.ngn.media.NgnProxyVideoConsumer;
import org.saydroid.ngn.media.NgnProxyVideoProducer;
import org.saydroid.ngn.model.NgnHistoryAVCallEvent;
import org.saydroid.ngn.model.NgnHistoryEvent;
import org.saydroid.ngn.services.INgnConfigurationService;
import org.saydroid.ngn.utils.NgnConfigurationEntry;
import org.saydroid.ngn.utils.NgnListUtils;
import org.saydroid.ngn.utils.NgnObservableHashMap;
import org.saydroid.ngn.utils.NgnPredicate;
...
public class NgnAVSession extends NgnInviteSession{
	...
	/**
	 * Change framerate of the camera
	 * @return
	 */
	public void changeFrameRate(int fps)
	{
		if(mVideoProducer != null)
		{
			mVideoProducer.changeFrameRate(fps);
		}
	}
