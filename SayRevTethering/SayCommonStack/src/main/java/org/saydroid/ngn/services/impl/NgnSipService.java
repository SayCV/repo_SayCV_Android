...
*/
package org.saydroid.ngn.services.impl;

import java.nio.ByteBuffer;
import java.util.UUID;

import org.saydroid.ngn.NgnApplication;
import org.saydroid.ngn.NgnEngine;
import org.saydroid.ngn.events.NgnInviteEventArgs;
import org.saydroid.ngn.events.NgnInviteEventTypes;
import org.saydroid.ngn.events.NgnMessagingEventArgs;
import org.saydroid.ngn.events.NgnMessagingEventTypes;
import org.saydroid.ngn.events.NgnPublicationEventArgs;
import org.saydroid.ngn.events.NgnPublicationEventTypes;
import org.saydroid.ngn.events.NgnRegistrationEventArgs;
import org.saydroid.ngn.events.NgnRegistrationEventTypes;
import org.saydroid.ngn.events.NgnSubscriptionEventArgs;
import org.saydroid.ngn.events.NgnSubscriptionEventTypes;
import org.saydroid.ngn.model.NgnDeviceInfo.Orientation;
...
import org.saydroid.ngn.sip.NgnAVSession;
import org.saydroid.ngn.sip.NgnInviteSession;
import org.saydroid.ngn.sip.NgnMessagingSession;
import org.saydroid.ngn.sip.NgnMsrpSession;
import org.saydroid.ngn.sip.NgnPresenceStatus;
import org.saydroid.ngn.sip.NgnPublicationSession;
import org.saydroid.ngn.sip.NgnRegistrationSession;
import org.saydroid.ngn.sip.NgnSipPrefrences;
import org.saydroid.ngn.sip.NgnSipSession;
import org.saydroid.ngn.sip.NgnSipStack;
import org.saydroid.ngn.sip.NgnSubscriptionSession;
import org.saydroid.ngn.sip.NgnInviteSession.InviteState;
import org.saydroid.ngn.sip.NgnSipSession.ConnectionState;
import org.saydroid.ngn.sip.NgnSipStack.STACK_STATE;
import org.saydroid.ngn.sip.NgnSubscriptionSession.EventPackageType;
import org.saydroid.ngn.utils.NgnConfigurationEntry;
import org.saydroid.ngn.utils.NgnContentType;
import org.saydroid.ngn.utils.NgnDateTimeUtils;
import org.saydroid.ngn.utils.NgnStringUtils;
import org.saydroid.ngn.utils.NgnUriUtils;
