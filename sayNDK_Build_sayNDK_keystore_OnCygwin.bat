...
keytool -genkey -alias sayNDK.keystore -keyalg RSA -validity 40000 -keystore sayNDK.keystore
rem assigned to apk
rem jarsigner -verbose -keystore demo.keystore -signedjar test_signed.apk test.apk demo.keystore
