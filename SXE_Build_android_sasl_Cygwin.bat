...
rem if not exist stamp_autogen_h (
rem 	bash --login -i -c "cd android-sasl/classpath-0.98 && ./autogen.sh && touch stamp_autogen_h"
rem )

if not exist stamp_configure_h (
	bash --login -i -c "cd android-sasl/classpath-0.98 && ./configure && touch stamp_configure_h"
)
